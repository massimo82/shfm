...
replace software.sslmate.com/src/go-pkcs12 => github.com/SSLMate/go-pkcs12 v0.5.0

replace golang.org/x/exp => github.com/golang/exp v0.0.0-20240719175910-8a7402abbf56
