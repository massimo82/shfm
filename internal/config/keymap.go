...
var keybindingDefs = []keybindingDef{
	...
	{ActionPageUp, []string{"pgup"}, "Page up"},
	{ActionPageDown, []string{"pgdown"}, "Page down"},
	...
	{ActionToggleSelect, []string{"space"}, "Toggle selection"},
	{ActionSelectAll, []string{"a"}, "Select all entries"},
	{ActionDeselectAll, []string{"A"}, "Deselect all entries"},

	{ActionCopy, []string{"ctrl+c"}, "Copy to clipboard"},
	{ActionPaste, []string{"ctrl+v"}, "Paste as copy"},
	...
	{ActionCancel, []string{"esc"}, "Cancel search/filter"},
